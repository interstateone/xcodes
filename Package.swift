...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "XcodesKit",
            dependencies: [
                "AppleAPI", .product(name: "Path", package: "Path.swift"), "Version", "PromiseKit", "PMKFoundation", "SwiftSoup", "ErrorHandling", "KeychainAccess"
            ]),
        .testTarget(
            name: "XcodesKitTests",
            dependencies: [
        ...
        .target(
            name: "AppleAPI",
            dependencies: [
                "PromiseKit", "PMKFoundation", "ErrorHandling"
            ]),
        .testTarget(
            name: "AppleAPITests",
